...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 27, 2017 lúc 06:07 AM
...
(3, '2017_09_07_135354_create_breeds_table', 1),
(4, '2017_09_07_135804_create_cats_table', 1);
...
--
ALTER TABLE `cats`
  ADD CONSTRAINT `cats_breed_id_foreign` FOREIGN KEY (`breed_id`) REFERENCES `breeds` (`id`);
COMMIT;
